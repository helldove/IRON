...
#ifndef ROUND_CONV_EVEN
#define ROUND_CONV_EVEN
#endif

#ifndef AIE_API_EMULATE_BFLOAT16_MMUL_WITH_BFP16
#define AIE_API_EMULATE_BFLOAT16_MMUL_WITH_BFP16
#endif
...
static inline void matmul_scalar_rowmaj(T_in *a, T_in *b, T_out *c)
{
    event0();
...
template <typename T_in,
          ...
          bool c_row_maj = true>
static inline void
matmul_vectorized_2x2_mmul_rowmaj(const T_in *__restrict pA, const T_in *__restrict pB, T_out *__restrict pC)
{
...
template <typename T_in,
          ...
          bool c_row_maj = true>
static inline void
matmul_vectorized_4x2_mmul_rowmaj(const T_in *__restrict pA, const T_in *__restrict pB, T_out *__restrict pC)
{
...
template <typename T_in,
          ...
          bool b_row_maj = true,
          bool c_row_maj = true>
static inline void matmul_vectorized_4x4_rowmaj(const T_in *__restrict pA, const T_in *__restrict pB, T_out *__restrict pC)
{
...
static inline void
matmul_vectorized_4x4x4_i16_i16_rowmaj(const int16 *__restrict pA, const int16 *__restrict pB, int16 *__restrict pC)
{
    constexpr int r = 4;
    constexpr int s = 4;
    constexpr int t = 4;
    ...
    return matmul_vectorized_2x2_mmul_rowmaj<int16, int16, (m / r), (k / s), (n / t), r, s, t, is_b_row_maj, is_c_row_maj>(
        pA, pB, pC);
}

template <unsigned m, unsigned k, unsigned n>
static inline void
matmul_vectorized_4x4x4_i16_i32_rowmaj(const int16 *__restrict pA, const int16 *__restrict pB, int32 *__restrict pC)
{
    constexpr int r = 4;
    constexpr int s = 4;
    constexpr int t = 4;
    ...
    return matmul_vectorized_2x2_mmul_rowmaj<int16, int32, (m / r), (k / s), (n / t), r, s, t, is_b_row_maj, is_c_row_maj>(
        pA, pB, pC);
}

template <unsigned m, unsigned k, unsigned n>
static inline void
matmul_vectorized_4x8x4_bf16_bf16_rowmaj(const bfloat16 *__restrict pA, const bfloat16 *__restrict pB, bfloat16 *__restrict pC)
{
    constexpr int r = 4;
    constexpr int s = 8;
    constexpr int t = 4;
    ...
    return matmul_vectorized_4x4_rowmaj<bfloat16, bfloat16, (m / r), (k / s), (n / t), r, s, t, is_b_row_maj, is_c_row_maj>(
        pA, pB, pC);
}

template <unsigned m, unsigned k, unsigned n>
static inline void
matmul_vectorized_4x8x4_bf16_f32_rowmaj(const bfloat16 *__restrict pA, const bfloat16 *__restrict pB, float *__restrict pC)
{
    constexpr int r = 4;
    constexpr int s = 8;
    constexpr int t = 4;
    ...
    return matmul_vectorized_4x4_rowmaj<bfloat16, float, (m / r), (k / s), (n / t), r, s, t, is_b_row_maj, is_c_row_maj>(
        pA, pB, pC);
}

template <unsigned m, unsigned k, unsigned n>
static inline void
matmul_vectorized_4x8x8_i8_i8_rowmaj(const int8 *__restrict pA, const int8 *__restrict pB, int8 *__restrict pC)
{
    constexpr int r = 4;
    constexpr int s = 8;
    constexpr int t = 8;
    ...
    return matmul_vectorized_4x2_mmul_rowmaj<int8, int8, (m / r), (k / s), (n / t), r, s, t, is_b_row_maj, is_c_row_maj>(
        pA, pB, pC);
}

template <unsigned m, unsigned k, unsigned n>
static inline void
matmul_vectorized_4x8x8_i8_i16_rowmaj(const int8 *__restrict pA, const int8 *__restrict pB, int16 *__restrict pC)
{
    constexpr int r = 4;
    constexpr int s = 8;
    constexpr int t = 8;
    ...
    return matmul_vectorized_4x2_mmul_rowmaj<int8, int16, (m / r), (k / s), (n / t), r, s, t, is_b_row_maj>(pA, pB, pC);
}

template <unsigned m, unsigned k, unsigned n>
static inline void
matmul_vectorized_4x8x8_i8_i32_rowmaj(const int8 *__restrict pA, const int8 *__restrict pB, int32 *__restrict pC)
{
    constexpr int r = 4;
    constexpr int s = 8;
    constexpr int t = 8;
    ...
    return matmul_vectorized_4x2_mmul_rowmaj<int8, int32, (m / r), (k / s), (n / t), r, s, t, is_b_row_maj>(pA, pB, pC);
}
...
#define matmul_vectorized_c_func(ctype_in, mlir_type_in, ctype_out, mlir_type_out, r, s, t)                            \
    void matmul_##mlir_type_in##_##mlir_type_out##_rowmaj(ctype_in *a_in, ctype_in *b_in, ctype_out *c_out)                     \
    {                                                                                                                  \
        matmul_vectorized_##r##x##s##x##t##_##mlir_type_in##_##mlir_type_out##_rowmaj<DIM_M, DIM_K, DIM_N>(a_in, b_in, c_out);  \
    }

#define matmul_scalar_c_func(ctype_in, mlir_type_in, ctype_out, mlir_type_out, r, s, t)                                \
    void matmul_scalar_##mlir_type_in##_##mlir_type_out##_rowmaj(ctype_in *a_in, ctype_in *b_in, ctype_out *c_out)              \
    {                                                                                                                  \
        matmul_scalar_rowmaj<ctype_in, ctype_out, DIM_M, DIM_K, DIM_N, is_b_row_maj, is_c_row_maj>(a_in, b_in, c_out);        \
    }

#define zero_vectorized_c_func(ctype_in, mlir_type_in, ctype_out, mlir_type_out, r, s, t)                              \
    void zero_##mlir_type_out##_rowmaj(ctype_out *c_out)                                                                        \
    {                                                                                                                  \
        zero_vectorized<ctype_out, DIM_M, DIM_N>(c_out);                                                               \
    }

#define zero_scalar_c_func(ctype_in, mlir_type_in, ctype_out, mlir_type_out, r, s, t)                                  \
    void zero_scalar_##mlir_type_out##_rowmaj(ctype_out *c_out)                                                                 \
    {                                                                                                                  \
